...
import CreateCartAndAddQuoteLinesIntoCart from '@salesforce/apex/IndividualQuoteRecords.createCartAndAddQuoteLinesIntoCart';
        ...
        if (this.quoteId) {
            ...
            fetchQuoteDetails({ quoteId: this.quoteId })
                .then(result => {
                    ...
                    this.quote.formattedSubtotal = this.formatPrice(this.quote.Subtotal);
                    this.quote.formattedTotalPrice = this.formatPrice(this.quote.TotalPrice);
                    this.quote.formattedDiscount = this.formatDiscount(this.quote.Discount);
                    this.quote.formattedExpirationDate = this.formatDate(this.quote.ExpirationDate);
                    //this.Quotes = result;
