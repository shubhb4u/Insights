...
//  c:/Users/Sajal Jain/Desktop/Ins/force-app/main/default/lwc/searchResults/searchResults
/**
...
export default class BuilderSearchResults extends LightningElement {
    ...
    @track product = {
        imageUrl: 'https://etgdigital6-dev-ed.develop.my.site.com/InsightsB2B/sfsites/c/cms/delivery/media/MC3FNYP7YPFNANRETVTABP3EMEEU?version=1.1&channelId=0apak000000JZTW&oid=00Dak000008AQzJ&width=330&height=330"'
    };

    connectedCallback() {
        console.log(this.product.imageUrl); // Check if the URL is correct
    }
    ...
    @api 
    showInlineQuantitySelector= false;
